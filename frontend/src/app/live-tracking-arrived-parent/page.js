...
export default function LiveTrackingWalker() {
        ...
        <div className="relative flex flex-col items-center justify-start min-h-screen bg-gray-100 p-8">
            ...
            <div className="mt-20 text-center">
                <p className="text-lg">
                    ...
                    <span className="text-green-600 font-bold">your walker</span>
                </p>
            </div>
            ...
            <div className="mt-18 text-center">
                <p className="text-lg font-bold">Walker have arrived at your destination</p>
            </div>
